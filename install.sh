...
NPM_PACKAGES="@anthropic-ai/claude-code @github/copilot @google/gemini-cli @openai/codex @owenizedd/bum @qwen-code/qwen-code@latest @sourcegraph/amp@latest 0x cline cordova esy flamebearer git-stats http-server neon-cli node-gyp nodemon npm npm-check-updates opencode-ai typesync"
PIP_PACKAGES="jupyterlab labelImg labelme notebook psrecord[plot] virtualenv"
UV_TOOLS="claude-monitor osxphotos"

FNM_VERSIONS="18.20.8 20.19.6 22.21.1 24.11.1"
