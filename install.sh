...
NPM_PACKAGES="@anthropic-ai/claude-code @openai/codex 0x cordova esy flamebearer git-stats http-server neon-cli node-gyp nodemon npm npm-check-updates opencode-ai typesync"
