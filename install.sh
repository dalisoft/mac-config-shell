...
BUN_NPM_PACKAGES="@github/copilot @mimo-ai/cli @qwen-code/qwen-code@latest @sourcegraph/amp@latest 0x cline command-code cordova esy flamebearer git-stats http-server neon-cli node-gyp nodemon npm npm-check-updates typesync"
...
external_setup() {
  ...
  sudo defaults write /Library/Preferences/org.chromium.Chromium QuicAllowed -bool false
  ...
  sudo defaults write /Library/Preferences/com.google.Chrome QuicAllowed -bool false
  ...
  sudo defaults write /Library/Preferences/com.microsoft.Edge QuicAllowed -bool false
...
post_installation() {
  ...
  defaults write com.apple.Terminal "Default Window Settings" "Translucent"
  defaults write com.apple.Terminal "Startup Window Settings" "Translucent"
}
